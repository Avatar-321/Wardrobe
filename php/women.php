...
?>
 ...
 <header class="head">
   ...
   <div class="container">
   <img src="Images/logow.jpg" width="150px" height="90px">
...
<form method="POST">
   <div class="small-container">
       <h1 class="headings">Womens' wear</h1>

       <div class="row">
           <?php
           $sql = "SELECT * FROM product WHERE category='Womens_Ware' ORDER by rand() LIMIT 24";
           if ($result = mysqli_query($conn, $sql)) {
               if (mysqli_num_rows($result) > 0) {
                   while ($row = mysqli_fetch_array($result)) {
